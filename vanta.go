...
func main() {
	...
	resource := flag.String("resource", "vulnerabilities", "resource to fetch: vulnerabilities, policies")
	flag.Parse()
	...
	default:
		log.Fatalf("unknown resource %q: must be vulnerabilities or policies", *resource)
	}
}
